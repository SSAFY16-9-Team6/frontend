...
export const PLACES: Place[] = [
    {
        ...
        category: '관광지',
        description:
            '부산 최고의 대표 해수욕장. 광활한 백사장과 우뚝 솟은 고층 빌딩숲이 완벽한 조화를 이루는 명실상부한 명소입니다.',
    ...
    },
    {
        ...
        category: '관광지',
        description:
            '앞바다가 훤히 내려다보이는 산자락에 아기자기한 파스텔톤 집들이 모여 있어 한국의 산토리니로 불리는 예술 마을입니다.',
    ...
    },
    {
        ...
        category: '관광지',
        description:
            '가파른 절벽 위에 세워진 하얀 주택들과 그 옆으로 끝없이 펼쳐지는 에메랄드빛 남해 바다가 압도적인 감성을 선사합니다.',
    ...
    },
    {
        ...
        category: '관광지',
        description:
            '푸른 서구 바다 위를 시원하게 활공하는 송도 해상케이블카와 짜릿한 바다 위 공중 산책길을 즐길 수 있습니다.',
    ...
    },
    {
        ...
        category: '관광지',
        description:
            '동구 도심 속 높은 산복도로 경사지를 기막히게 오르내리는 모노레일과 근현대사의 숨결을 가득 품은 레트로 골목입니다.',
    ...
    },
    {
        ...
        category: '문화시설',
        description:
            '기존 공구 골목의 낡은 분위기를 젊은 예술가들과 개성 만점 바리스타들이 뉴트로 핫플레이스로 재탄생시켰습니다.',
    ...
    },
    {
        ...
        category: '관광지',
        description:
            '남구 바다 절벽 끝자락에 설치된 유리 스카이워크를 거닐며 세찬 파도와 신비로운 오륙도의 자태를 가장 가까이서 감상할 수 있습니다.',
    ...
    },
    {
        ...
        category: '쇼핑',
        description:
            '오이소, 보이소, 사이소! 활력이 흘러 넘치는 대한민국 대표 수산시장으로 싱싱한 제철 해산물의 먹방 재미가 쏠쏠합니다.',
    ...
    },
    {
        ...
        category: '관광지',
        description:
            '맑은 낙동강 줄기를 굽어보는 북구 금정산 맑은 기슭에 위치하여 푸른 온실 식물들과 한적한 피톤치드 힐링을 선사합니다.',
